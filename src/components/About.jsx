 ...
 text-white px-7 py-[14px]"
          ...
          <div className="w-full md:w-7/12 px-3  ">
            ...
            <div className="flex-col-reverse flex md:flex-col  ">
              <p className=" text-base font-Poppins px-4 md:px-0 text-center mx-auto md:text-start text-black leading-xl opacity-80 max-w-[665px] font-normal mb-2 md:mb-10">
              ...
              <img
                className="w-full max-sm:min-h-[240px] max-sm:max-w-[400px] px-1 pb-2 md:pb-0 md:px-0"
